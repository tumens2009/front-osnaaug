...
```js | pure
import { getMenuData } from '@/components/ant/layout/src';
...
```ts | pure
// 可以通过 import { Settings } from '@/components/ant/layout/src/defaultSettings'
// 来获取这个类型
...
```ts | pure
// 可以通过 import { MenuDataItem } from '@/components/ant/layout/src'
// 来获取这个类型
...
```ts | pure
// 可以通过 import { RouterTypes } from '@/components/ant/layout/src/lib/typings';
// 来获取这个类型
