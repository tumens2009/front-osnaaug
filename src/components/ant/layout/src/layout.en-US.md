...
```tsx | pure
import { RouteContext, RouteContextType } from '@/components/ant/layout/src';
...
```js | pure import { getMenuData } from '@/components/ant/layout/src';
...
```js | pure
import { getPageTitle } from '@/components/ant/layout/src';
...
```ts | pure
// You can get this type by importing { Settings } from '@/components/ant/layout/src/defaultSettings'
// to get this type
...
```ts | pure
// You can get this type by importing { MenuDataItem } from '@/components/ant/layout/src'
// to get this type
...
```ts | pure
// You can get this type by importing { RouterTypes } from '@/components/ant/layout/src/lib/typings';
// to get this type
