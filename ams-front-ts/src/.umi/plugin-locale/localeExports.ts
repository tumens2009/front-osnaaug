...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'C:/Sources/AMSProject/git/ams-front-ts/node_modules/@umijs/plugin-locale/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'C:/Sources/AMSProject/git/ams-front-ts/node_modules/warning/warning.js';
...
import lang_enUS0 from "C:/Sources/AMSProject/git/ams-front-ts/src/locales/en-US.ts";
import mnMN0 from 'antd/es/locale/mn_MN';
import lang_mnMN0 from "C:/Sources/AMSProject/git/ams-front-ts/src/locales/mn-MN.ts";
...
export const getIntl = (locale?: string, changeIntl?: boolean) => {
  ...
  // 使用 zh-CN
  if (localeInfo["mn-MN"]) return createIntl(localeInfo["mn-MN"]);
