...
import { omitUndefined, isDeepEqualReact } from '@/components/ant/utils/src';
...
function getButtonText({
  ...
  return {
    reload: {
      text: intl.getMessage('tableToolBar.reload', 'Reload'),
      icon: <ReloadOutlined />,
    },
    density: {
      text: intl.getMessage('tableToolBar.density', 'Density'),
      icon: <DensityIcon />,
    },
    setting: {
      text: intl.getMessage('tableToolBar.columnSetting', 'Column Set'),
      icon: <SettingOutlined />,
    },
    fullScreen: {
      text: intl.getMessage('tableToolBar.fullScreen', 'Fullscreen'),
      icon: <FullScreenIcon />,
    },
  };
}
