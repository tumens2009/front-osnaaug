...
import { pickProProps, omitUndefined } from '@/components/ant/utils/src';

import ConfigContext, { useIntl } from '@/components/ant/provider/src';
      ...
      {defaultRenderText(
        ...
        valueType || 'text',
        {
          ...
          renderFormItem: renderFormItem
            ? (...restProps) => {
                ...
                if (React.isValidElement(newDom))
                  return React.cloneElement(newDom, {
                    placeholder:
                      rest.placeholder || intl.getMessage('tableForm.inputPlaceholder', 'Please enter'),
                    ...fieldProps,
                    ...((newDom.props as any) || {}),
                  });
                return newDom;
            ...
            : undefined,
          placeholder: rest.placeholder || intl.getMessage('tableForm.inputPlaceholder', 'Please enter'),
