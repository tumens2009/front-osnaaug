...
export type PageHeaderTabConfig = {
  ...
  /** @name Currently selected tab 的 key */
  tabActiveKey?: TabsProps['activeKey'];

  /** @name tab Trigger on modification */
  onTabChange?: TabsProps['onChange'];

  /** @name tab Additional area */
  tabBarExtraContent?: TabsProps['tabBarExtraContent'];

  /** @name tabs Other configurations */
  tabProps?: TabsProps;

  /**
   * @deprecated please use fixedHeader
   * @name fixed PageHeader To the top of the page
   */
  fixHeader?: boolean;
